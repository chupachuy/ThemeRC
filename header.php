...
<head>
  ...
  <title>Rancho California</title>
  <meta content="Fraccionamiento Exclusivo y moderno con solo 39 residencias estilo California, 8 modelos a escoger de una y dos plantas, con 2, 3, 4 y 5 recamaras, cocina integral moderna, doble altura, cochera cerrada y alberca privada en cada residencia." name="description">
  <meta content="Residencia, Casa, Fraccionamiento, Vallarta, Puerto Vallarta, Club Residencial, Vivienda , Preventa, Pre-venta, Rancho California" name="keywords">
  ...
  <link href="<?php bloginfo('template_url'); ?>/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  ...
  <!-- font awesome -->
  <!--<link href="<?php bloginfo('template_url'); ?>/assets/fontawesome-free-6.2.1-web/css/all.min.css" rel="stylesheet">-->
  <link href="<?php bloginfo('template_url'); ?>/assets/fontawesome6/pro/css/all.min.css" rel="stylesheet">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-1QTYJBK6WC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-1QTYJBK6WC');
</script>
  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope-fill"></i><a href="mailto:contact@example.com">info@ranchocalifornia.mx</a>
        <i class="bi bi-phone-fill phone-icon"></i> <a class="disable-link" href="tel:+523222655909">+52 322 265 5909</a>
      </div>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo me-auto">
        ...
        <a href="index.html"><img src="<?php bloginfo('template_url'); ?>/assets/img/logotipo.png" alt="" class="img-fluid"></a>
      </div>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Home</a></li>
          <li><a class="nav-link scrollto" href="#amenidades">Amenidades</a></li>
          <li class="dropdown"><a href="#"><span>Modelos</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#modelos">Residencias</a></li>
              <li><a href="#california">Edificio California</a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="#ubicacion">Ubicación</a></li>
          <li><a class="nav-link scrollto" href="#disponibilidad">Disponibilidad</a></li>
          <!--<li><a class="nav-link scrollto" href="#gallery">Galería</a></li>-->
          <li><a class="nav-link scrollto" href="#financiamiento">Financiamiento</a></li>
